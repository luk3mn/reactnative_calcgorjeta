...
export default () => {
  // Criando as variáveis para receber as entradas
  ...
  const calc = () => {
    let nBill = parseFloat(bill); // Convete a variável bill para float
  ...
  return (
    <Page>
      ...
      {tip > 0 && // Só exibe se tip for maior que 0
        <ResultArea>
